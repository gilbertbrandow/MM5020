...
\item %\subsection*{Group Action on \(\mathbb{P}^1(k)\)}
...
\item %\subsection*{Transitivity and the Stabilizer of 0}
...
\item %\subsection*{Kernel of the Action}
...
\item %\subsection*{Intersection of Conjugates of the Stabilizer}
...
\subsection*{Find normal subgroups}
We are asked to find the normal subgroups of \( S_4 \) that contain \( V_4 \). From group theory, the normal subgroups of \( S_4 \) are:
\[
